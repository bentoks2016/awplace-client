...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://shrouded-beach-17036.herokuapp.com/',
...
var prodEvents = __webpack_require__(11);
...
var onSignUp = function onSignUp(event) {
  ...
  authApi.signUp(data).then(ui.signUpResponse).catch(ui.signUpError);
};
...
var onSignOut = function onSignOut(event) {
  ...
  authApi.signOut(event).then(ui.signOutSuccess).catch(ui.signOutFailure);
};
...
var getFormFields = __webpack_require__(2);
var productApi = __webpack_require__(12);
...
var onCreateProduct = function onCreateProduct(event) {
  ...
  productApi.productCreate(data).then(productUi.createProductSuccess).catch(productUi.createProductFail);
};
...
var onGetAllProducts = function onGetAllProducts(event) {
  ...
  productApi.prodShowAll(test).then(productUi.getAllProductSuccess).catch(productUi.getAllProductError);
};
...
var onUpdateProduct = function onUpdateProduct(event) {
  ...
  productApi.prodUpdate(data).then(productUi.getUpdateProductSuccess).catch(productUi.getUpdateProductError);
};
...
var onDeleteProduct = function onDeleteProduct(event) {
  ...
  productApi.prodDelete(data.product).then(productUi.getDeleteProductSuccess).catch(productUi.getDeleteProductError);
};

var onViewProduct = function onViewProduct(event) {
  event.preventDefault();
  console.log('this is view 1');
  var data = getFormFields(event.target);
  console.log('data is ', data);
  productApi.prodView(data.product).then(productUi.getViewProductSuccess).catch(productUi.getViewProductFail);
};
...
var prodShowAll = function prodShowAll(test) {
...
var prodUpdate = function prodUpdate(data) {
...
var prodDelete = function prodDelete(product) {
...
var prodView = function prodView(product) {
...
var createProductSuccess = function createProductSuccess(createProductResponse) {
  console.log('product was created here ', createProductResponse);
  $('#successfulProdCreate').toggleClass('hide').fadeOut(3000);
};

var createProductFail = function createProductFail(failCreateProd) {
  console.log('sign up error is ', failCreateProd);
  $('#failedProdCreate').toggleClass('hide').fadeOut(3000);
};

var getAllProductSuccess = function getAllProductSuccess(getAllProductResponse) {
...
var getAllProductFail = function getAllProductFail(error) {
  console.log('Error in sign up is ', error);
};

var getDeleteProductSuccess = function getDeleteProductSuccess(deleteProductResponse) {
  console.log('delete product was success ', deleteProductResponse);
  $('#successfulProdDelete').toggleClass('hide').fadeOut(3000);
};

var getDeleteProductFail = function getDeleteProductFail(deleteProductFailResponse) {
  console.log('delete failed here ', deleteProductFailResponse);
  $('#failedProdDelete').toggleClass('hide').fadeOut(3000);
};

var getUpdateProductSuccess = function getUpdateProductSuccess(updateProductResponse) {
  console.log('update was success ', updateProductResponse);
};

var getUpdateProductFail = function getUpdateProductFail(updateProductFailResponse) {
  console.log('update failed here ', updateProductFailResponse);
};

var getViewProductSuccess = function getViewProductSuccess(viewProductResponse) {
...
var getViewProductFail = function getViewProductFail(viewProductFailResponse) {
...
module.exports = {
  ...
  getAllProductFail: getAllProductFail,
  getDeleteProductSuccess: getDeleteProductSuccess,
  getDeleteProductFail: getDeleteProductFail,
  getUpdateProductSuccess: getUpdateProductSuccess,
  getUpdateProductFail: getUpdateProductFail,
  getViewProductSuccess: getViewProductSuccess,
  getViewProductFail: getViewProductFail
...
var tableCreate = function tableCreate(json) {
